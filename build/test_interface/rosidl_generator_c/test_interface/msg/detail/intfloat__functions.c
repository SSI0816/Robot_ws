...
test_interface__msg__Intfloat__create()
{
  ...
  test_interface__msg__Intfloat * msg = (test_interface__msg__Intfloat *)allocator.allocate(sizeof(test_interface__msg__Intfloat), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(test_interface__msg__Intfloat));
  bool success = test_interface__msg__Intfloat__init(msg);
  if (!success) {
...
test_interface__msg__Intfloat__destroy(test_interface__msg__Intfloat * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    test_interface__msg__Intfloat__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
test_interface__msg__Intfloat__Sequence__init(test_interface__msg__Intfloat__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface__msg__Intfloat * data = NULL;

  if (size) {
    data = (test_interface__msg__Intfloat *)allocator.zero_allocate(size, sizeof(test_interface__msg__Intfloat), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = test_interface__msg__Intfloat__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        test_interface__msg__Intfloat__fini(&data[i - 1]);
      }
...
test_interface__msg__Intfloat__Sequence__fini(test_interface__msg__Intfloat__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      test_interface__msg__Intfloat__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  test_interface__msg__Intfloat__Sequence * array = (test_interface__msg__Intfloat__Sequence *)allocator.allocate(sizeof(test_interface__msg__Intfloat__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = test_interface__msg__Intfloat__Sequence__init(array, size);
  if (!success) {
...
test_interface__msg__Intfloat__Sequence__destroy(test_interface__msg__Intfloat__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    test_interface__msg__Intfloat__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
test_interface__msg__Intfloat__Sequence__are_equal(const test_interface__msg__Intfloat__Sequence * lhs, const test_interface__msg__Intfloat__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!test_interface__msg__Intfloat__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  test_interface__msg__Intfloat__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(test_interface__msg__Intfloat);
    test_interface__msg__Intfloat * data =
      (test_interface__msg__Intfloat *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!test_interface__msg__Intfloat__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          test_interface__msg__Intfloat__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!test_interface__msg__Intfloat__copy(
